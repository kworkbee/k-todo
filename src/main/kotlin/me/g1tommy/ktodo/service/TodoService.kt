...
class TodoService(private val todoRepository: TodoRepository) {
    ...
    fun todo(id: Long): Mono<TodoItemResponse> {
        return todoRepository.existsById(id)
            ...
            .flatMap { todo -> Mono.just(TodoItemResponse(todo.id, todo.title, todo.content, todo.due, todo.done, todo.createdAt, todo.updatedAt)) }
    }
        ...
        return todoRepository.existsById(id)
            .flatMap { isExist ->
                ...
                todoRepository.save(newTodo).flatMap {
                    updatedTodo -> Mono.just(TodoItemResponse(updatedTodo.id, updatedTodo.title, updatedTodo.content, updatedTodo.due, updatedTodo.done, updatedTodo.createdAt, updatedTodo.updatedAt))
                }
            }
    }
